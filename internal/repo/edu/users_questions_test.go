...
func testUsersQuestionsSoftDelete(t *testing.T) {
	t.Parallel()
...
func testUsersQuestionsQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := UsersQuestions().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testUsersQuestionsSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testUsersQuestionsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := UsersQuestions().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
