...
func (o *User) GetUsersQuestions() UsersQuestionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUsersQuestions()
}

func (r *userR) GetUsersQuestions() UsersQuestionSlice {
	if r == nil {
		return nil
	}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "edu: failed to execute a one query for users")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "edu: failed to check if users exists")
	}
...
func (o *User) UsersQuestions(mods ...qm.QueryMod) usersQuestionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"users_questions\".\"user_id\"=?", o.TGUserID),
	)
...
func (userL) LoadUsersQuestions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	if singular {
		...
		args[object.TGUserID] = struct{}{}
	} else {
		for _, obj := range slice {
			if obj.R == nil {
				obj.R = &userR{}
			}
			args[obj.TGUserID] = struct{}{}
		}
	}
	...
	query := NewQuery(
		...
		qm.WhereIn(`users_questions.user_id in ?`, argsSlice...),
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.TGUserID == foreign.UserID {
...
func (o *User) AddUsersQuestions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersQuestion) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []interface{}{o.TGUserID, rel.ID}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, tGUserID int64, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"tg_user_id\"=$1 and \"deleted_at\" is null", sel,
	)

	q := queries.Raw(query, tGUserID)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "edu: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("edu: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to insert into users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("edu: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("edu: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("edu: unable to upsert users, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userPrimaryKeyColumns) == 0 {
				return errors.New("edu: unable to upsert users, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to upsert users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"users\" WHERE \"tg_user_id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"users\" SET %s WHERE \"tg_user_id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("edu: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete all from user slice")
	}
...
func (o *User) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUser(ctx, exec, o.TGUserID)
	if err != nil {
		return err
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, tGUserID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"tg_user_id\"=$1 and \"deleted_at\" is null limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, tGUserID)
	}
	row := exec.QueryRowContext(ctx, sql, tGUserID)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "edu: unable to check if users exists")
	}
...
func (o *User) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserExists(ctx, exec, o.TGUserID)
}
