...
type Question struct {
	...
	IsTask    bool      `db:"is_task" pg:"is_task" boil:"is_task" json:"is_task" toml:"is_task" yaml:"is_task"`
...
var QuestionWhere = struct {
	...
	IsTask:    whereHelperbool{field: "\"questions\".\"is_task\""},
}
...
func (o *Question) GetAnswers() AnswerSlice {
	if o == nil {
		return nil
	}
...
func (o *Question) GetUsersQuestions() UsersQuestionSlice {
	if o == nil {
		return nil
	}
...
var (
	questionAllColumns            = []string{"id", "question", "created_at", "updated_at", "deleted_at", "tag_id", "is_task"}
	questionColumnsWithoutDefault = []string{"tag_id"}
	questionColumnsWithDefault    = []string{"id", "question", "created_at", "updated_at", "deleted_at", "is_task"}
