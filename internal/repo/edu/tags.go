...
type Tag struct {
	...
	Tag       string    `db:"tag" pg:"tag" boil:"tag" json:"tag" toml:"tag" yaml:"tag"`
...
type tagR struct {
	Questions QuestionSlice `db:"Questions" pg:"Questions" boil:"Questions" json:"Questions" toml:"Questions" yaml:"Questions"`
}
...
func (o *Tag) GetQuestions() QuestionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetQuestions()
}

func (r *tagR) GetQuestions() QuestionSlice {
	if r == nil {
		return nil
	}
...
func (q tagQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Tag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "edu: failed to execute a one query for tags")
	}
...
func (q tagQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to count tags rows")
	}
...
func (q tagQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "edu: failed to check if tags exists")
	}
...
func (o *Tag) Questions(mods ...qm.QueryMod) questionQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"questions\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadQuestions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(
		qm.From(`questions`),
		qm.WhereIn(`questions.tag_id in ?`, argsSlice...),
...
func FindTag(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Tag, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "edu: unable to select from tags")
	}
...
func (o *Tag) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("edu: no tags provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to insert into tags")
	}
...
func (o *Tag) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("edu: unable to update tags, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update tags row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by update for tags")
	}
...
func (q tagQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update all for tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to retrieve rows affected for tags")
	}
...
func (o TagSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to update all in tag slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to retrieve rows affected all in update all tag")
	}
	return rowsAff, nil
}
...
func (o *Tag) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("edu: no tags provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("edu: unable to upsert tags, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(tagPrimaryKeyColumns) == 0 {
				return errors.New("edu: unable to upsert tags, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to upsert tags")
	}
...
func (o *Tag) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete from tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by delete for tags")
	}
...
func (q tagQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("edu: no tagQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete all from tags")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "edu: failed to get rows affected by deleteall for tags")
	}
...
func (o TagSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "edu: unable to delete all from tag slice")
	}
...
func (o *TagSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "edu: unable to reload all in TagSlice")
	}
...
func TagExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "edu: unable to check if tags exists")
	}
